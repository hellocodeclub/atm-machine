...
public class AppController {
    ...
    private void showMoney(boolean empty) throws FileNotFoundException {
        ...
        if(empty){
            imageLocation = new FileInputStream("<REPLACE>/atm-machine/src/main/resources/atm-empty.png");
        }else {
            imageLocation = new FileInputStream("<REPLACE>/atm-machine/src/main/resources/atm-with-cash.png");
        }
